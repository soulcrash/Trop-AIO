...
using TropAIO.Utility;
using LeagueSharp.Common;
using SharpDX;
using TropAIO.Properties;
using iLucian;
using EloBuddy.SDK;
            ...
            if (!Loader.utilOnly)
            {
                switch (ObjectManager.Player.ChampionName.ToLower())
                {
                    ...
                    case "akali": // Akali by xQx
                        ...
                        {
                            case 0:
                                TropAIO.Champion.Akali.Program.Main();
                                break;
                            case 1:
                                ExorAIO.AIO.OnLoad();
                                break;
                    ...
                    case "amumu": // Shine#
                        ...
                        {
                            case 0:
                                TropAIO.Champion.Amumu.Program.OnLoad();
                                break;
                            case 1:
                                ExorAIO.AIO.OnLoad();
                                break;
                    ...
                    case "blitzcrank": // Fresh Booster & OKTW
                        ...
                        {
                            case 0:
                                TropAIO.Champion.Blitzcrank.Program.OnLoad();
                                break;
                            case 1:
                                SebbyLib.Program.GameOnOnGameLoad();
                                break;
                    ...
                    case "brand": // TheBrand (or OKTWBrand)
                        ...
                        {
                            case 0:
                                TropAIO.Champion.Brand.Program.Load();
                                break;
                            case 1:
                                SebbyLib.Program.GameOnOnGameLoad();
                                break;
                    ...
                    case "taric": // SkyLv_Taric
                        ...
                        break;
                    default:
                        Chat.Print("This champion is not supported yet but the utilities will still load! - Soulcrash");
                        break;
                }
            }
        }
